  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-lg font-semibold">Asset Summary</h2>
      ...
      <div className="rounded-lg border bg-white p-6 shadow-sm">
        <h2 className="mb-2 text-lg font-semibold">Assigned Assets</h2>
        <p className="text-sm text-muted-foreground">
          Company laptops, phones, badges, keys, software licenses, and return
