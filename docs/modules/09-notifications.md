...
The Notifications module delivers timely, actionable messages generated by HR workflows across the platform.
...
- Provide consistent in-app messaging
...
Included: in-app notifications, recipient resolution, read/unread status, links to source records, email delivery, preferences, delivery history.

Planned: digest emails, templates, Slack, Teams, SMS, push notifications.
...
`notifications`, `notification_recipients`, `notification_preferences`, `notification_templates`, `notification_deliveries`
...
2. Recipient rules
3. Email delivery
4. Preferences and templates
5. Digests and external channels
