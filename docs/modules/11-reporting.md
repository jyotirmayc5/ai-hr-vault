...
The Reporting module provides operational dashboards, filtered reports, exports, and reusable analytics across all HR modules.

---

# 2. Business Goals

- Provide accurate workforce insight
- Reduce spreadsheet reporting
- Standardize metrics
- Support executive and operational decisions
- Maintain secure exports

---

# 3. Scope

Included: dashboards, standard reports, filters, CSV, PDF, report metadata, permission enforcement.

Planned: saved reports, scheduled delivery, XLSX, custom report builder, analytics warehouse.
...
`report_definitions`, `saved_reports`, `report_runs`, `report_exports`, `report_schedules`
...
1. Shared filters and exports
2. Standard module reports
3. Executive dashboards
4. Saved and scheduled reports
5. Custom builder and warehouse
