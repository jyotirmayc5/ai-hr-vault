...
The Performance Management module supports review cycles, goals, feedback, ratings, development plans, and performance history.
...
Included: review templates, review cycles, self-review, manager review, goals, feedback, ratings, development plans, reports.

Planned: calibration, 360 reviews, continuous feedback, succession planning.
...
`performance_cycles`, `review_templates`, `employee_reviews`, `review_responses`, `employee_goals`, `feedback`, `development_plans`
...
4. Reporting
5. Calibration and talent planning
