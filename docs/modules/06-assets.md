...
The Asset Management module tracks company property assigned to employees throughout onboarding, daily use, transfer, return, maintenance, and retirement.
...
- Create auditable assignment history

---

# 3. Scope

Included: asset inventory, categories, assignment, transfer, return, condition, status, employee history, reports, notifications.

Planned: maintenance, warranties, vendors, depreciation, barcode and QR scanning.
...
`assets`, `asset_categories`, `employee_assets`, `asset_assignments`, `asset_maintenance`, `asset_audit_logs`
