...
The Permissions module defines who can view and change data across companies, modules, records, and sensitive fields.
...
- Support clear organizational roles
...
Included: roles, permissions, company membership, module access, action access, field restrictions, manager scope, employee self-service, RLS alignment.

Planned: custom roles, permission groups, temporary access, access reviews.
...
`roles`, `permissions`, `role_permissions`, `profile_roles`, `company_memberships`, `access_audit_logs`
...
/dashboard/settings/access-reviews
```
...
5. Custom roles and access reviews
